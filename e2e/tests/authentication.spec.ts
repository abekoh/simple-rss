...
test.describe('Authentication', () => {
  ...
  test('should display authentication section in sidebar', async ({ page }) => {
    // On mobile, need to open the drawer first
    await openMobileDrawerIfNeeded(page);
  ...
  test('should display authentication section in mobile drawer', async ({ page }) => {
    // Set mobile viewport
  ...
  test('should preserve authentication state across page reloads', async ({ page }) => {
