...
export type GetFeedsQuery = { __typename?: 'Query', feeds: Array<{ __typename?: 'Feed', feedId: string, url: string, title: string, description?: string | null, registeredAt: any, lastFetchedAt?: any | null, tags: Array<{ __typename?: 'Tag', name: string, special: boolean }> }> };
...
export type GetPostsQuery = { __typename?: 'Query', posts: { __typename?: 'PostsPayload', totalCount: number, posts: Array<{ __typename?: 'Post', postId: string, feedId: string, url: string, title: string, description?: string | null, author?: string | null, status: PostStatus, postedAt?: any | null, lastFetchedAt?: any | null, summary?: { __typename?: 'PostSummary', summary: string, summarizeMethod: string, summarizedAt: any } | null, feed: { __typename?: 'Feed', feedId: string, title: string, url: string, registeredAt: any, tags: Array<{ __typename?: 'Tag', name: string, special: boolean }> }, favorite?: { __typename?: 'PostFavorite', postFavoriteId: string, addedAt: any } | null }> } };
...
export type RenameFeedTitleMutation = { __typename?: 'Mutation', renameFeedTitle: { __typename?: 'RenameFeedTitlePayload', feedId: string } };
...
export type ReplaceFeedTagsMutation = { __typename?: 'Mutation', replaceFeedTags: { __typename?: 'ReplaceFeedTagsPayload', feedId: string } };
...
export const RenameFeedTitleDocument = gql`
  ...
  renameFeedTitle(input: $input) {
    ...
    `;
export type RenameFeedTitleMutationFn = Apollo.MutationFunction<RenameFeedTitleMutation, RenameFeedTitleMutationVariables>;
 ...
 * });
 */
export function useRenameFeedTitleMutation(baseOptions?: Apollo.MutationHookOptions<RenameFeedTitleMutation, RenameFeedTitleMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RenameFeedTitleMutation, RenameFeedTitleMutationVariables>(RenameFeedTitleDocument, options);
      }
export type RenameFeedTitleMutationHookResult = ReturnType<typeof useRenameFeedTitleMutation>;
export type RenameFeedTitleMutationResult = Apollo.MutationResult<RenameFeedTitleMutation>;
export type RenameFeedTitleMutationOptions = Apollo.BaseMutationOptions<RenameFeedTitleMutation, RenameFeedTitleMutationVariables>;
export const ReplaceFeedTagsDocument = gql`
  ...
  replaceFeedTags(input: $input) {
    ...
    `;
export type ReplaceFeedTagsMutationFn = Apollo.MutationFunction<ReplaceFeedTagsMutation, ReplaceFeedTagsMutationVariables>;
 ...
 * });
 */
export function useReplaceFeedTagsMutation(baseOptions?: Apollo.MutationHookOptions<ReplaceFeedTagsMutation, ReplaceFeedTagsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ReplaceFeedTagsMutation, ReplaceFeedTagsMutationVariables>(ReplaceFeedTagsDocument, options);
      }
export type ReplaceFeedTagsMutationHookResult = ReturnType<typeof useReplaceFeedTagsMutation>;
export type ReplaceFeedTagsMutationResult = Apollo.MutationResult<ReplaceFeedTagsMutation>;
export type ReplaceFeedTagsMutationOptions = Apollo.BaseMutationOptions<ReplaceFeedTagsMutation, ReplaceFeedTagsMutationVariables>;